...
function carrega(){
    ...
    document.getElementById('field-points').addEventListener('blur', leave);   
}
function leave(){
    if(this.value != ''){
...
function inputSHOW(_show){
    if(_show){
        ...
        document.getElementById('field-points').offsetParent.className += " ativo";
        ...
        document.getElementById('field-points').offsetParent.className = 'box';
